    ...
    <div className="container mx-auto px-6 max-w-2xl text-center text-shadow-dark">
      ...
      <div className="fade-item space-y-1">
        <p className="font-body text-foreground/80 text-base">
          Valor completo <span className="line-through text-foreground/40 mr-1">R$2.917</span> → Lançamento: 12x de <span className="text-primary font-cinzel">R$27,92</span> ou R$270 à vista
        </p>
