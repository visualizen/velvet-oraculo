...
const EbookHero = ({ onOpenModal }: EbookHeroProps) => (
  <TextureSection
    ...
    id="ebook-hero"
  >
    <div className="container mx-auto px-5 sm:px-6 py-12 sm:py-16 md:py-24 lg:py-28">
      <div className="flex flex-col lg:flex-row items-center gap-8 sm:gap-10 lg:gap-16 xl:gap-20 max-w-6xl mx-auto">

        {/* Left — Device Mockup with Floating Animation */}
        <div className="fade-item flex-shrink-0 w-full max-w-[260px] sm:max-w-[340px] lg:max-w-[400px] relative order-1">
          ...
          <div className="relative z-10 flex items-end justify-center">
            ...
            <div className="animate-float-tablet relative">
              <div className="relative w-[170px] sm:w-[220px] md:w-[240px] lg:w-[260px] rounded-[14px] sm:rounded-[16px] bg-[#111] p-[5px] sm:p-[6px] shadow-[0_20px_70px_rgba(201,169,110,0.12),0_6px_24px_rgba(0,0,0,0.45)]">
            ...
            {/* Phone Frame */}
            <div className="animate-float-phone relative -ml-5 sm:-ml-8 md:-ml-10 mb-4 sm:mb-6">
              <div className="relative w-[68px] sm:w-[88px] md:w-[96px] lg:w-[105px] rounded-[10px] sm:rounded-[14px] bg-[#111] p-[3px] sm:p-[4px] shadow-[0_16px_50px_rgba(201,169,110,0.18),0_4px_18px_rgba(0,0,0,0.5)]">
                {/* Notch */}
        ...
        <div className="flex-1 text-center lg:text-left max-w-xl order-2">
          <p className="fade-item font-cinzel text-primary/50 text-[0.6rem] sm:text-[0.65rem] tracking-[0.4em] uppercase mb-3 sm:mb-5">
            ✦ Velvet Oráculo ✦
          </p>
          ...
          {/* Benefits */}
          <ul className="fade-item space-y-2.5 sm:space-y-3 mb-6 sm:mb-8">
            {[
          ...
          <div className="fade-item flex flex-col items-center lg:items-start gap-2.5">
            <button
              onClick={onOpenModal}
              className="inline-block font-cinzel tracking-[0.18em] sm:tracking-[0.22em] text-[0.7rem] sm:text-[0.75rem] font-bold px-8 sm:px-9 py-3.5 sm:py-4 bg-primary text-primary-foreground rounded-sm border border-primary/50 hover:bg-primary/90 hover:translate-y-[-2px] hover:shadow-[0_8px_24px_rgba(201,169,110,0.25)] transition-all duration-500 animate-cta-glow cursor-pointer uppercase"
            >
